    ...
    <body>
        <div>
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rp <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>&clear_table=1" class="btn btn-primary" name="clear_table">Confirm Order</a>
            ...
            <footer class="footer">
               <div class="container">
               <center>
                   <p>Pizzaria, All Rights Reserved. | Since 2077</p>
               </center>
               </div>
           </footer>
        </div>
