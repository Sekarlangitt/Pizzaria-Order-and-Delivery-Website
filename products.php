            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/mushroom.jpeg" alt="mushroom">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/meatlasagna.jpg" alt="meatlasagna">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Meat Lasagna</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/cajunchickenlasagna.jpg" alt="chickenlasagna">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cajun Chicken Lasagna</h3>
                                    <p>Price: Rp. 15.000</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/seafoodlasagna.jpg" alt="seafoodlasagna">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Seafood Lasagna</h3>
                                    <p>Price: Rp. 15.0000</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/lamblasagna.jpg" alt="lamb lasagna">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Lamb Lasagna</h3>
